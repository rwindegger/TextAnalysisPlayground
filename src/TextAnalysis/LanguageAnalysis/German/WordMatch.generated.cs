...
{
	[System.Serializable()]
	public partial class WordMatch : IDataErrorInfo, INotifyPropertyChanging, INotifyPropertyChanged, System.Runtime.Serialization.ISerializable
	{
		...
		public virtual string DefinitionId
		{
			...
			set
			{
				...
				{
					this.OnPropertyChanging("DefinitionId");
		...
		public virtual WordDefinition WordDefinition
		{
			get
			{
			...
			set
			{
				if(this._wordDefinition != value)
				{
					this.OnPropertyChanging("WordDefinition");
					this._wordDefinition = value;
					this.OnPropertyChanged("WordDefinition");
				}
			}
		}
		...
		protected WordMatch(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
		{
			this.Word = info.GetString("Word");
			this.DefinitionId = info.GetString("DefinitionId");
			CustomizeDeserializationProcess(info, context);
		}
		
		public virtual void GetObjectData(System.Runtime.Serialization.SerializationInfo info, System.Runtime.Serialization.StreamingContext context)
		{
			info.AddValue("Word", this.Word, typeof(string));
			info.AddValue("DefinitionId", this.DefinitionId, typeof(string));
